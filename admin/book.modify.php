          ...
          <div class="animated fadeIn">
            ...
            <div class="row">
              ...
              <div class="col-lg-12">
                <div class="card">
                  <div class="card-header">
                      <strong class="card-title mb-3">添加新书</strong>
                  </div>
                  <div class="card-body">
                    <button type="button" class="btn btn-outline-secondary" onclick="location.href='book.add.php?callnumber=<?php echo $callnumber?>'">单项添加</button>
                    ...
                    <table class="table table-striped">
                      ...
                      ?>
                        <tr>
                          ...
                          <td>
                            <a href="handle/book.del.handle.php?bid=<?php echo $value['bid']?>">删除</a>
                          </td>
                        </tr>
                      <?php }}?>
                      </tbody>
