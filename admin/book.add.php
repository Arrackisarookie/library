              ...
              <div class="page-header float-right">
                <div class="page-title">
                  <ol class="breadcrumb text-right">
                    ...
                    <li><a href="biblio.manage.php">Book</a></li>
              ...
              <div class="col-lg-12">
                <div class="card">
                  ...
                  <div class="card-body card-block">
                    <form action="handle/book.add.handle.php" method="post" class="form-horizontal">
                      <input type="hidden" id="callnumber" name="callnumber" class="form-control" value="<?php echo $_GET['callnumber']?>">
                      <div class="row form-group">
                        <div class="col col-md-2"><label for="bid" class=" form-control-label">图书编号</label></div>
                        <div class="col-12 col-md-5"><input type="text" id="bid" name="bid" placeholder="图书编号" class="form-control"></div>
                      </div>
