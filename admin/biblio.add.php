              ...
              <div class="col-lg-12">
                <div class="card">
                  ...
                  <div class="card-body card-block">
                    <form action="handle/biblio.add.handle.php" method="post" class="form-horizontal">
                      <div class="row form-group">
                        <div class="col col-md-2"><label for="callnumber" class=" form-control-label">索书号</label></div>
                        <div class="col-12 col-md-5"><input type="text" id="callnumber" name="callnumber" placeholder="索书号" class="form-control"></div>
                      </div>
                      <div class="row form-group">
                        <div class="col col-md-2"><label for="biblioname" class=" form-control-label">书名</label></div>
                        <div class="col-12 col-md-5"><input type="text" id="biblioname" name="biblioname" placeholder="书名" class="form-control"></div>
                      </div>
                      <div class="row form-group">
                        <div class="col col-md-2"><label for="author" class=" form-control-label">作者</label></div>
                        <div class="col-12 col-md-5"><input type="text" id="author" name="author" placeholder="作者" class="form-control"></div>
                      </div>
                      <div class="row form-group">
                        <div class="col col-md-2"><label for="press" class=" form-control-label">出版社</label></div>
                        <div class="col-12 col-md-5"><input type="text" id="press" name="press" placeholder="出版社" class="form-control"></div>
                      </div>
                      <div class="row form-group">
                        <div class="col col-md-2"><label for="publishingtime" class=" form-control-label">出版年份</label></div>
                        <div class="col-12 col-md-5"><input type="number" min="1900" max="2030" step="1" id="publishingtime" name="publishingtime" placeholder="出版年份" class="form-control"></div>
                      </div>
                      <div class="row form-group">
                        <div class="col col-md-2"><label for="isbn" class=" form-control-label">ISBN</label></div>
                        <div class="col-12 col-md-5"><input type="text" id="isbn" name="isbn" placeholder="ISBN" class="form-control"></div>
                      </div>
                      <div class="row form-group">
                        <div class="col col-md-2"><label for="category" class=" form-control-label">类别</label></div>
                        <div class="col-12 col-md-5"><input type="text" id="category" name="category" placeholder="类别" class="form-control"></div>
                      </div>
                      <div class="row form-group">
                        <div class="col col-md-2"><label for="price" class=" form-control-label">价格</label></div>
                        <div class="col-12 col-md-5"><input type="number" min="0" step="0.01" id="price" name="价格" placeholder="price" class="form-control"></div>
                      </div>
                      <div class="row form-group">
                          <div class="col col-md-2"><label for="intro" class="form-control-label">简介</label></div>
                          <div class="col-12 col-md-5"><textarea class="form-control" id="intro" rows="3" name="intro"></textarea></div>
                      </div>
                      <div class="row form-group">
