              ...
              <div class="page-header float-right">
                <div class="page-title">
                  <ol class="breadcrumb text-right">
                    ...
                    <li><a href="user.manage.php">User</a></li>
            ...
            <div class="col-lg-12">
              <div class="card">
                ...
                <div class="card-body card-block">
                  <form action="handle/user.add.handle.php" method="post" class="form-horizontal">
                    <div class="row form-group">
                      <div class="col col-md-2"><label for="sid" class=" form-control-label">学号</label></div>
                      <div class="col-12 col-md-5"><input type="text" id="sid" name="sid" placeholder="学号" class="form-control"></div>
                    </div>
                    <div class="row form-group">
                      <div class="col col-md-2"><label for="username" class=" form-control-label">姓名</label></div>
                      <div class="col-12 col-md-5"><input type="text" id="username" name="username" placeholder="姓名" class="form-control"></div>
                    </div>
                    ...
                    <div class="row form-group">
                      ...
                      <div class="col col-md-9">
                        <div class="custom-control custom-radio custom-control-inline">
                          <input type="radio" id="sexMale" name="sex" value="1" class="custom-control-input">
                          <label class="custom-control-label" for="sexMale">男</label>
                        </div>
                        <div class="custom-control custom-radio custom-control-inline">
                          <input type="radio" id="sexFamale" name="sex" value="0" class="custom-control-input">
                    ...
                    <div class="row form-group">
                      ...
                      <div class="col-12 col-md-5"><input type="text" id="birth" name="birth" placeholder="出生日期" class="form-control"></div>
                    </div>
                    <div class="row form-group">
                    ...
                    <div class="row form-group">
                      ...
                      <div class="col-12 col-md-5"><input type="text" id="class_" name="class_" placeholder="班级" class="form-control"></div>
                    </div>
                    <div class="row form-group">
