<?php
    ...
    $recount = mysqli_fetch_row(mysqli_query($con, "select COUNT(*) from tb_record"));
    mysqli_close($con);
?>
            ...
            <div class="page-header float-right">
              <div class="page-title">
                <ol class="breadcrumb text-right">
                  ...
                  <li class="active">Database Manage</li>
                </ol>
              </div>
            </div>
          </div>
    ...
    <div class="content">
      ...
      <div class="animated fadeIn">
        <div class="row">
          ...
          <div class="col-lg-3 col-md-6" onclick="location.href='biblio.manage.php'" onmouseover="style.cursor='pointer'">
            <div class="card">
              <div class="card-body">
                <div class="stat-widget-five">
                  ...
                  <div class="stat-content">
                    <div class="text-left dib">
                      <div class="stat-text"><span class="count"><?php echo $bicount[0]?></span></div>
                      <div class="stat-heading">Bibliography</div>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div class="card">
              <div class="card-body">
                <div class="stat-widget-five">
                  ...
                  <div class="stat-content">
                    <div class="text-left dib">
                      <div class="stat-text"><span class="count"><?php echo $bcount[0]?></span></div>
          ...
          <div class="col-lg-3 col-md-6" onclick="location.href='user.manage.php'" onmouseover="style.cursor='pointer'">
            <div class="card">
              <div class="card-body">
                <div class="stat-widget-five">
                  ...
                  <div class="stat-content">
                    <div class="text-left dib">
                      <div class="stat-text"><span class="count"><?php echo $usercount[0]?></span></div>
          ...
          <div class="col-lg-3 col-md-6" onclick="location.href='record.manage.php'" onmouseover="style.cursor='pointer'">
            <div class="card">
              <div class="card-body">
                <div class="stat-widget-five">
                  ...
                  <div class="stat-content">
                    <div class="text-left dib">
                      <div class="stat-text"><span class="count"><?php echo $recount[0]?></span></div>
                      <div class="stat-heading">Record</div>
                    </div>
                  </div>
                </div>
              </div>
