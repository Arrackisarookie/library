<?php
    ...
    $updatesql = "update tb_bibliography set biblioname = '$biblioname', author = '$author', press = '$press', publishing_time = $publishingtime, ISBN = '$isbn', category = '$category', price = $price where call_number = '$callnumber'";
