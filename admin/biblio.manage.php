<?php
    ...
    $sql = "select * from tb_bibliography order by call_number";
          ...
          <div class="row">
            ...
            <div class="col-lg-12">
              <div class="card">
                ...
                <div class="card-body">
                  <button type="button" class="btn btn-outline-secondary" onclick="location.href='biblio.add.php'">单项添加</button>
              ...
              <div class="card">
                ...
                <div class="card-body">
                  <table class="table table-striped">
                    ...
                    ?>
                      <tr>
                        <th scope="row"><?php echo $value['call_number']?></th>
                        <td><a href="book.modify.php?callnumber=<?php echo $value['call_number']?>"><?php echo $value['biblioname']?></a></td>
                        <td><?php echo $value['author']?></td>
                        <td><?php echo $value['press']?></td>
                        <td><?php echo $value['publishing_time']?></td>
                        <td><?php echo $value['ISBN']?></td>
                        <td><?php echo $value['category']?></td>
                        <td><?php echo $value['price']?></td>
                        <td>
                          <a href="biblio.modify.php?callnumber=<?php echo $value['call_number']?>">修改</a>
                          <a href="handle/biblio.del.handle.php?callnumber=<?php echo $value['call_number']?>">删除</a>
                        </td>
                      </tr>
                    <?php }}?>
                    </tbody>
